...
public class SceneGraph extends JPanel {
    ...
    private void createWorld() {
        ...
        w21.setScale(1*offsetScale, 1*offsetScale).setColor(Color.orange);
        w21.setTranslation(-2.7*offsetScale + offsetX, -0.15*offsetScale + offsetY);

        w22 = new TransformedObject(filledPolygon);
        w22.setScale(1*offsetScale, 1*offsetScale).setColor(Color.orange);
        ...
        w31.setScale(1.7*offsetScale, 1.7*offsetScale).setColor(Color.orange);
        w31.setTranslation(-3.9*offsetScale + offsetX, -1.5*offsetScale + offsetY);

        w32 = new TransformedObject(filledPolygon);
        w32.setScale(1.7*offsetScale, 1.7*offsetScale).setColor(Color.orange);
